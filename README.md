 ...
 # React API'dan Veri Çekme ve Birleştirme
 ...
 * [Patika Dev sayfasına gitmek için tıklayın](https://app.patika.dev/paths)

* [Ödev sayfasına gitmek için tıklayın](https://app.patika.dev/paths)
